...
export class ContentpageComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    if (this.currentSearch) {
      this.contentpageService
        ...
        .subscribe(
          (res: HttpResponse<IContentpage[]>) => this.paginateContentpages(res.body, res.headers),
  ...
  trackId(index: number, item: IContentpage) {
    return item.id;
  }

  registerChangeInContentpages() {
    this.eventSubscriber = this.eventManager.subscribe('contentpageListModification', response => this.loadAll());
  }
  ...
  protected paginateContentpages(data: IContentpage[], headers: HttpHeaders) {
