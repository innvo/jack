...
import { ContentpageComponent } from 'app/entities/contentpage/contentpage.component';
...
describe('Component Tests', () => {
  describe('Contentpage Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.contentpages[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
