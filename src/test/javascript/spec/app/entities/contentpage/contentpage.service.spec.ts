...
describe('Service Tests', () => {
  describe('Contentpage Service', () => {
    ...
    beforeEach(() => {
      ...
      expectedResult = {};
      injector = getTestBed();
      service = injector.get(ContentpageService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new Contentpage(0, 'AAAAAAA', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Contentpage', async () => {
      ...
      it('should return a list of Contentpage', async () => {
        const returnedFromService = Object.assign(
          {
            title: 'BBBBBB',
            content: 'BBBBBB'
      ...
      it('should delete a Contentpage', async () => {
